...
<head>
    ...
    <title>Formulir Hasil Nilai Mahasiswa</title>
</head>
<body>
    <div class="bg-primary p-5">
    <h1 class="text-center text-white">Formulir Hasil Nilai Siswa</h1>
    </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <select class="form-select form-control" class="form-control" name="lesson">
                    ...
                    <option value="WEB Programming">MatKom</option>
                    <option value="Database">Basis Data</option>
                    <option value="Statistika">UI/UX</option>
                    <option value="PKN">WEB</option>
                </select>
                <div class="form-group">
            ...
            <div class="col-3 mt-3">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item">Nilai Alfabet: </li>
